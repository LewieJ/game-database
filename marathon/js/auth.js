            ...
            section.innerHTML = `
                <div class="mobile-more-section">
                    ...
                    <div class="mobile-more-grid">
                        <a href="/player-profiles/u/${encodeURIComponent(user.username)}/" class="mobile-more-item" style="border-color: var(--neon); color: var(--neon);">
                            ${avatarHtml}
                ...
                el.innerHTML = `
                    <div class="nav-auth-dropdown">
                        ...
                        <div class="nav-auth-menu">
                            <a href="/player-profiles/u/${encodeURIComponent(user.username)}/" class="nav-auth-item">
